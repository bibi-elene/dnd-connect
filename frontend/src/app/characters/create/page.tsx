...
const characterImages: Record<string, Record<string, string>> = {
  fighter: {
...
const backgroundOptions = ['Noble', 'Acolyte', 'Folk-Hero', 'Thief'];
const skillsOptions = ['History', 'Athletics', 'Survival', 'Performance'];
